...
import { userLoginThunk, userThunk } from '../../slices/AuthSlice';
                    ...
                    <div className='size-full p-14 flex flex-col gap-6 animate-inputShow'>
                        <div>
                            ...
                            <div   className='flex w-full h-[40px]  justify-center'>
                                <button className='flex w-1/2 h-full bg-main-font rounded-2xl justify-center items-center text-main-front font-bold'>Login</button>
                            </div>
                    </div>
            </form>
    </div>
